package neo.ehsanodyssey.java.spring.handler;
...
public class ProjectHandler {
    ...
    public Mono<ServerResponse> findProject(ServerRequest request) {
        Mono<Project> project = this.service.findByName(request.pathVariable("name"));
        return ServerResponse.ok().contentType(MediaType.APPLICATION_JSON).body(project, Project.class);
    }
}