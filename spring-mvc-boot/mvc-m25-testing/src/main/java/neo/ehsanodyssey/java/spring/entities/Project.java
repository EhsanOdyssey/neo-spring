...
public class Project {
	...
	private String name;
	@NotBlank(message = "You should provide a description.") // Bean Validation
	...
	public Project(Long projectId, String name, @NotBlank(message = "You should provide a description.") String description) {
