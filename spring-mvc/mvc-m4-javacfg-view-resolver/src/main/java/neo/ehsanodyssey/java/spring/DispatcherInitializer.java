...
public class DispatcherInitializer extends AbstractAnnotationConfigDispatcherServletInitializer {
    ...
    // because a view resolver is in web component, we need to registered with the application context for of dispatcher servlet so we need to configure that in WebConfig class
    @Override
