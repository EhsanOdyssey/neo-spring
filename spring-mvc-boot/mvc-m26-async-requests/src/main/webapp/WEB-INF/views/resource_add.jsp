    ...
    <form:form action="${formUrl}" method="POST" modelAttribute="resource">
        <div class="row">
            ...
            <div class="form-group">
                ...
                <a id="pricing-link-deferredresult" href="<spring:url value="/resource/pricing/deferredresult" />">Get
                    Price (by DeferredResult)</a>
                <br>
                <a id="pricing-link-callableobject" href="<spring:url value="/resource/pricing/callableobject" />">Get
                    Price (by Callable Object)</a>
                <br>
                <a id="pricing-link-stream-sse" href="<spring:url value="/resource/pricing/sse" />">Get
                    Price (by Stream SseEmitter)</a>
            </div>
